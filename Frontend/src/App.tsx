...
export const App = () => {
  ...
  useEffect(() => {
    ...
    map.current.on("load", async () => {
      ...
      try {
        const resPuyas = await fetch("https://comanche-6jja.onrender.com/api/puyas_info");
        ...
        const resTrack = await fetch("https://comanche-6jja.onrender.com/api/track");
        ...
        const resCurvas20s = await fetch("https://comanche-6jja.onrender.com/api/curva20s");
        ...
        const resCurvas5s = await fetch("https://comanche-6jja.onrender.com/api/curva5s");
